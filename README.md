...
Use this checklist to track your learning progress as you work through the tutorial:

### Git Basics
- [ ] Understand what Git is and why it's used
- [ ] Install Git and configure username/email (`git config`)
...
- [ ] Undo changes (`git revert` / `git reset`)
